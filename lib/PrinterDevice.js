...
class PrinterDevice extends Homey.Device {
  async onInit() {
    ...
    this.client.on('connected', () => {
      ...
      this.homey.flow.getTriggerCard('printer_online').trigger(this).catch(this.error);
    });
    ...
    this.client.on('disconnected', () => {
      ...
      this.homey.flow.getTriggerCard('printer_offline').trigger(this).catch(this.error);
    });
